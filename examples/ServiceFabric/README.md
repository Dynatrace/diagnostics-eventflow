...
The full example project can be found [here](https://github.com/Dynatrace/diagnostics-eventflow/tree/output-dynatrace-examples/examples/ServiceFabric/eventflow).

**Note**
*The project is included directly in the Visual Studio solution of the EventFlow library for easier testing during development. Since this will not be part of the official repo that will contribute back to the origin project, it is held in it's own branch "output-dynatrace-examples"*
...
The full service project can be found [here](https://github.com/Dynatrace/diagnostics-eventflow/tree/output-dynatrace-examples/examples/ServiceFabric/monitoring-service).
